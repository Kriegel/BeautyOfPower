Function Format-BoPsCodeCasing {
<#
.Synopsis
...
<#
 ...
 Format-BoPsCodeCasing -Code (Get-Content -Path 'C:\temp\Attribs.ps1' -Raw) -Verbose

 Format-BoPsCodeCasing -Code (Get-Content -Path 'D:\SVNRepository\PowerShell\Entwicklung\Security\Get-RegistrySDDescriptor.ps1' -Raw) -Verbose | Out-File -FilePath 'D:\SVNRepository\PowerShell\Entwicklung\Security\Get-RegistrySDDescriptor-Beau.ps1'
